...
import de.aittr.config.AppConfig;
...
public class Main2 {
    public static void main(String[] args) {
        ...
        ApplicationContext applicationContext = new AnnotationConfigApplicationContext(AppConfig.class); // создали контекст и передали описания наших бинов

        UsersService usersService = applicationContext.getBean(UsersService.class); // получаем бин-сервис с уже проставленным репозиторием
